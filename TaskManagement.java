...
import object_oriented_programming.module_3.Task;
...
public class TaskManagement {
    public static void main(String s[]) {
        ...
        try (scanner) {
            ...
            while (true) {
                ...
                // Option 4: Update a task by name
                    ...
                    if (taskBook.containsKey(keyName)) {
                        ...
                        System.out
                                .println("Enter the new status for the task P for 'In Progress' or C for 'Completed'");
                        ...
                        if (updatedStatus.equalsIgnoreCase("P")) {
                            ...
                            taskBook.get(keyName).setStatus(Task.COMPLETE);
                        }
                ...
                // Option 6: Sort the entries by taskName
                    ...
                    TreeMap<String, Task> taskBookTreeMap = new TreeMap<String, Task>(taskBook);
            ...
            // Handle invalid number input (for example, non-integer input for priority or
            // index)
